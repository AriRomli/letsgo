...
import bengkelkreatif.letsgo.Network.ApiServices;
import bengkelkreatif.letsgo.Network.InitLibrary;
import bengkelkreatif.letsgo.response.Distance;
import bengkelkreatif.letsgo.response.Duration;
import bengkelkreatif.letsgo.response.LegsItem;
...
public class OjekActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private String API_KEY = "AIzaSyAfHTRmaA6dt-eoTAwC3lnw-BDI44Oactw";
