...

{
    ...
    //press ctrl 0
    //because we request runtime permission, we need override OnRequstpermissionMethod
            ...
            if (location_switch.isChecked()) {
                ...
                geoFire.setLocation(FirebaseAuth.getInstance().getCurrentUser().getUid(), new GeoLocation(latitude, longitude), new GeoFire.CompletionListener() {
                    ...
                    public void onComplete(String key, DatabaseError error) {
                        //Add Marker
                        Log.i("DISPLAY LOCATION", "------location sent to geoFire");
                        ...
                        Log.i("DISPLAY LOCATION", "------marker added");
                        ...
                        Log.i("DISPLAY LOCATION", "------begin rotation");
